...
/*   Updated: 2017/04/13 07:40:29 by mbouanik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	ft_display_arg_u_uintm_dash(t_type *lst, uintmax_t n, int size)
{
...
void	ft_display_arg_u_uintm_no_dash2(t_type *lst, uintmax_t n, int size)
{
...
void	ft_display_arg_u_uintm_no_dash(t_type *lst, uintmax_t n, int size)
{
	if (MFW > PMFW)
	{
		ft_memset_g_set(g_str, ' ', MFW - PMFW);
...
void	ft_display_arg_u_uintm_no_dash3(t_type *lst, uintmax_t n, int size)
{
	if (FLAGS & 4)
	{
		if (FLAGS & 8 && size++)
